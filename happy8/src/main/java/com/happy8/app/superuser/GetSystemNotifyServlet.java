...
public class GetSystemNotifyServlet extends HttpServlet{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static Logger log = LoggerFactory.getLogger(GetSystemNotifyServlet.class);
	@Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response){
		try{
			...
			List<SystemNotifyItem> res = Happy8DAO.getSystemNotify(start, end);
			...
			log.error("GetSystemNotifyServlet process error",ex);

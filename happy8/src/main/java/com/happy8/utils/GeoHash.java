...
public final class GeoHash implements Comparable<GeoHash>, Serializable {
	...
	public String[] getAdjacentToString(String geo) {
		GeoHash northern = getNorthernNeighbour();
		GeoHash eastern = getEasternNeighbour();
		GeoHash southern = getSouthernNeighbour();
		GeoHash western = getWesternNeighbour();
		return new String[] { geo,northern.toBase32(), northern.getEasternNeighbour().toBase32(), eastern.toBase32(), southern.getEasternNeighbour().toBase32(),
				southern.toBase32(),
				southern.getWesternNeighbour().toBase32(), western.toBase32(), northern.getWesternNeighbour().toBase32()};
	}
